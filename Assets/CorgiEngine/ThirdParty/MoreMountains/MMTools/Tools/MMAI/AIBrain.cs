...
namespace MoreMountains.Tools
{
    ...
    public class AIBrain : MonoBehaviour
    {
        ...
        protected float _preventChangingStateTimer;
        ...
        {
            if (_preventChangingStateTimer > 0)
            {
                _preventChangingStateTimer -= Time.deltaTime;
                return;
            }
        ...
        public void PreventChangingState(float time)
        {
            _preventChangingStateTimer = time;
        }
    }
}
