...
public class NNiblerMovement : NPathMovementBase
{
    ...
    protected override void Start()
    {
        ...
        _patrol = GetComponent<NEnemyPatrol>();
    ...
    private bool CanMoveToMinMax(Vector3 position)
    {
        if (_patrol != null)
        {
            if (position.x > _patrol.MaxX || position.x < _patrol.MinX)
                return false;
        }
