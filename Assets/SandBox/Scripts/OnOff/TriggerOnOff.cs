...
public class TriggerOnOff : OnOff
{
    ...
    protected void OnTriggerEnter2D(Collider2D other) => HandleTriggerEnter(other.gameObject.tag);
    protected void OnTriggerEnter(Collider other) => HandleTriggerEnter(other.gameObject.tag);
